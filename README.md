...
<!--头像-->
<div class="cs">
	<!-- src表示头像的地址,建议上传到网页,然后放链接 -->
 <a href="D:\wang zhan\网站\hhthq2.html"""> <img src="D:/wang zhan/网站/照片/情侣头像.jpg" id="logo"></a>
</div>

<canvas class="canvas" width="1820" height="905"></canvas>
<p class="text" style="color: #8ef5ff;">
    how far are we to paradise?
    the time is now
    <br/>
...
<script language="javascript">
    function show_date_time() {
		...
		//我俩在一起的那天
        BirthDay = new Date("10/27/2021 00:00:00");
        today = new Date();
...
<audio autoplay="autoplay" controls="controls"loop="loop" preload="auto"
            ...
            src="D:\wang zhan\网站\paradise音乐.mp3">
</audio>
</body>
</html>
